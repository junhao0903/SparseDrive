...
num_occ_classes = len(occ_class_names)
roi_size = (30, 60)
    ...
    head=dict(
        ...
        polygon_occ_head=dict(
            ...
            instance_bank=dict(
                ...
                embed_dims=embed_dims,
                anchor="data/kmeans/kmeans_polygon_occ_100_20.npy",
...
polygon_occ_info_dir = "data/polygon_occ_infos"
...
eval_config = dict(
    **data_basic_config,
    ...
    polygon_occ_ann_file=f"{polygon_occ_info_dir}/polygon_occ_val.pkl",
...
data = dict(
    ...
    train=dict(
        **data_basic_config,
        ...
        polygon_occ_ann_file=f"{polygon_occ_info_dir}/polygon_occ_train.pkl",
